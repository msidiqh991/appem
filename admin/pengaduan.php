 ...
 <div class="card shadow mb-4">
	...
	<?php 
		...
		<tr>
			...
			<td>
                <a href="#pengaduan<?php echo $r['id_pengaduan'] ?>" class="btn btn-primary btn-icon-split" data-toggle="modal" data-target="#pengaduan<?php echo $r['id_pengaduan'] ?>">
...
<!-- Modal -->
<div class="modal fade" id="pengaduan<?php echo $r['id_pengaduan'] ?>" tabindex="-1" role="dialog" aria-labelledby="pengaduanLabel" aria-hidden="true">
<div id="pengaduan?id_pengaduan=<?php echo $r['id_pengaduan'] ?>">
